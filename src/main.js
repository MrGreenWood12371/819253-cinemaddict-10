...
const filmsContainer = siteMainElement.querySelector(`.films-list`).querySelector(`.films-list__container`);
...
for (let i = 0; i < topFilmsContainer.length; i++) {
  render(topFilmsContainer[i].querySelector(`.films-list__container`), createCardTemplate(), `beforeend`);
  render(topFilmsContainer[i].querySelector(`.films-list__container`), createCardTemplate(), `beforeend`);
}
